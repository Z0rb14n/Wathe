...
public interface WatheBlockEntities {
    ...
    BlockEntityType<VentHatchBlockEntity> VENT_HATCH = registrar.create("vent_hatch", BlockEntityType.Builder.create((pos, state) -> new VentHatchBlockEntity(WatheBlockEntities.VENT_HATCH, pos, state), WatheBlocks.STAINLESS_STEEL_VENT_HATCH, WatheBlocks.DARK_STEEL_VENT_HATCH, WatheBlocks.TARNISHED_GOLD_VENT_HATCH));
